...
class EDL_NULL:
    ...
    def edl_null_feeds_df(self):
        ...
        edlNullObj = NullCheck(self.df, 'file')
    ...
    def status_null_feeds(self, null_feeds_list):
        ...
        nullStatusObj.null_status(null_feeds_list, "edl", 'file')

    def remove_problem_feeds_list(self, null_feeds_list):
        list = problemlist.feeds_list_minus_problem_feeds(null_feeds_list, "edl", "file")
    ...
    def replacing_problematic_values(self):
        replace_df = problemlist.replacing_problematic_values(self.df, self.dateObj, "edl", "0", "file")
        return replace_df
    ...
    def edl_new_feed_query_information(self):
        ...
        print(f"  Place (new_edl_file_feeds_{self.dateObj.year_file}{self.dateObj.month_file}{self.dateObj.day_file}.csv) file in the inpout folder\n") 

    def edl_file_count_query(self, null_list):
        line.title_between_line("EDL FILE COUNT QOUERY")
        
        fileEdlQueryObj = EDL_QueryMaker(self.dateObj, null_list)
    ...
    def executive(self):
        ...
        self.edl_file_count_query(edl_null_feeds)
